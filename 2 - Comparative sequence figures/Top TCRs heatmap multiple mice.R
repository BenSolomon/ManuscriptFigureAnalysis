...
df.1 <- read.csv("D:\\Dropbox\\Hsieh Lab\\Data Analysis\\Foxp3 RORgt Figures\\CleanedFoxp3RORgt.csv", header = T)

df.1 <- average.reads.f(df.1, "Colon") #Generates average population frequencies across mice for given tissue
